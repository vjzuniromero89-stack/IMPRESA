...
function MoneyControl({sales,expenses,accounts,month,rate,accountHistory}:any){
 ...
 let running=opening;
 const flowRows:any[]=[[`${month}-01`,'Saldo inicial','Saldo inicial de Banco y Efectivo','Todas las cuentas','—','—',dual(opening,rate)]];
