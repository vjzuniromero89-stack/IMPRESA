...
function MethodBadge({method}:{method?:string}){const cls=method==='Transferencia'?'transfer':method==='Efectivo'?'cash':'unclassified';return <span className={'methodBadge '+cls}>{method||'Sin clasificar'}</span>}
